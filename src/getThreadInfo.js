...
module.exports = function(defaultFuncs, api, ctx) {
  ...
  return function getThreadInfoGraphQL(threadID, callback) {
    ...
    if (utils.getType(callback) != "Function" && utils.getType(callback) != "AsyncFunction") {
      ...
      // Found mid-January 2023 by @Anup - shared to Public group
      // Codes similar to this muliti thread can all be copy ideas
      // applied to new fca(cloud - fca(private)) at the end of January 2023
      // update this abandoned project on 09/102/2023 by @Anup(Owner)

      var time = new Date().toLocaleDateString('en-IN',  {minute: 'numeric' }).split(',')[0]
    ...
    var SpecialMethod = function(TID) {
      ...
      if (All.length < 1) {
        ...
        .post("https://www.facebook.com/api/graphqlbatch/", ctx.jar, form)
          ...
          if (resData.error) {
            throw "Error: getThreadInfoGraphQL Maybe You Spam Too Much"
          }
