...
module.exports = function(defaultFuncs, api, ctx) {
  return function getThreadInfoGraphQL(threadID, callback) {
    ...
    //* similar muliti thread codes like this can all be copy ideas
    //*update this abandoned project on 02/09/2023 by @Anup(Owner)
    ...
    .catch(function(err) {
      log.error("getThreadInfoGraphQL", "error: getThreadInfoGraphQL Maybe You Spam Too Much, Try Again !");
    return callback(err);
  });
