        ...
        if (Link.includes('facebook.com') || Link.includes('Facebook.com') || Link.includes('fb')) {
            ...
            if (LinkSplit.indexOf("https:") == 0) {
              if (!isNaN(LinkSplit[3]) && !Link.split('=')[1]  && !isNaN(Link.split('=')[1])) {
                api.sendMessage('Wrong Link, Link Needs Format As Follows: facebook.com/t3ra.b44p.Anup.h3r3',global.Fca.Data.event.threadID,global.Fca.Data.event.messageID);
            ...
            callback(null, null);
            api.sendMessage('Wrong Link, Link Needs To Be A Facebook Link',global.Fca.Data.event.threadID,global.Fca.Data.event.messageID)
        }
    }
    catch (e) {
